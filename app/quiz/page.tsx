...
export default function QuizPage() {
    ...
    const totalQuestions = Math.min(10, questionsData.filter((q) => q.group === group).length);
    ...
    useEffect(() => {
        // 問題データがまだ読み込まれていない or currentIndexが範囲外なら処理しない
        ...
        // 正解以外から9個ランダム選択
        const others = questionsData
            .filter((q) => q.answer !== correct && q.group === group)
